...
const FORMS = {
  ...
  contact: {
    ...
    payload: {
      ...
      student_name: 'GIIS Lead Capture Test Student',
      parentWeChat: 'giis-lead-capture-test',
      parent_wechat: 'giis-lead-capture-test',
      email: 'lead-capture-test@example.com',
      contact_email: 'lead-capture-test@example.com',
      pathway: 'Not sure yet',
      pathway_interest: 'Not sure yet',
      grade: '10',
      grade_level: '10',
      leadSummary: 'Student: GIIS Lead Capture Test Student\nEmail: lead-capture-test@example.com\nGrade: 10',
      message: 'TEST SUBMISSION from GIIS lead-capture verification. Please mark handled and do not treat as a real lead.',
    },
  },
};
