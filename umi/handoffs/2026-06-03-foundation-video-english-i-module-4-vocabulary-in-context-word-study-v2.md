...
- Course: English I
- Module: 4: Vocabulary in Context & Word Study
- Target folder: `teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2/`
- Source packet: `teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2/source_packet.json`
- Teaching brief: `teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2/teaching_brief.md`
- Visual brief: `teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2/visual_brief.md`
...
```bash
python3 tools/lesson-video/foundation_video_gate.py teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2 --render-mp4
python3 tools/lesson-video/lesson_release_gate.py teaching-videos/english-i-module-4-vocabulary-in-context-word-study-v2 --check
```
