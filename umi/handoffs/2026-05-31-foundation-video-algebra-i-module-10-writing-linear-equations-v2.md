...
- Target folder: `teaching-videos/algebra-i-module-10-writing-linear-equations-v2/`
- Source packet: `teaching-videos/algebra-i-module-10-writing-linear-equations-v2/source_packet.json`
- Teaching brief: `teaching-videos/algebra-i-module-10-writing-linear-equations-v2/teaching_brief.md`
- Visual brief: `teaching-videos/algebra-i-module-10-writing-linear-equations-v2/visual_brief.md`
...
```bash
python3 tools/lesson-video/foundation_video_gate.py teaching-videos/algebra-i-module-10-writing-linear-equations-v2 --render-mp4
python3 tools/lesson-video/lesson_release_gate.py teaching-videos/algebra-i-module-10-writing-linear-equations-v2 --check
```
