...
- Course: Algebra I
- Module: 5: Solving Multi-Step Equations & Literal Equations
- Target folder: `teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2/`
- Source packet: `teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2/source_packet.json`
- Teaching brief: `teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2/teaching_brief.md`
- Visual brief: `teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2/visual_brief.md`
...
```bash
python3 tools/lesson-video/foundation_video_gate.py teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2 --render-mp4
python3 tools/lesson-video/lesson_release_gate.py teaching-videos/algebra-i-module-5-solving-multi-step-equations-literal-v2 --check
```
