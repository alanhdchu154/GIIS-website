...
- Target folder: `teaching-videos/biology-module-5-photosynthesis-v2/`
- Source packet: `teaching-videos/biology-module-5-photosynthesis-v2/source_packet.json`
- Teaching brief: `teaching-videos/biology-module-5-photosynthesis-v2/teaching_brief.md`
- Visual brief: `teaching-videos/biology-module-5-photosynthesis-v2/visual_brief.md`
...
```bash
python3 tools/lesson-video/foundation_video_gate.py teaching-videos/biology-module-5-photosynthesis-v2 --render-mp4
python3 tools/lesson-video/lesson_release_gate.py teaching-videos/biology-module-5-photosynthesis-v2 --check
```
