...
- Course: English I
- Module: 10: Novel Study: Character & Theme
- Target folder: `teaching-videos/english-i-module-10-novel-study-character-theme-v2/`
- Source packet: `teaching-videos/english-i-module-10-novel-study-character-theme-v2/source_packet.json`
- Teaching brief: `teaching-videos/english-i-module-10-novel-study-character-theme-v2/teaching_brief.md`
- Visual brief: `teaching-videos/english-i-module-10-novel-study-character-theme-v2/visual_brief.md`
...
```bash
python3 tools/lesson-video/foundation_video_gate.py teaching-videos/english-i-module-10-novel-study-character-theme-v2 --render-mp4
python3 tools/lesson-video/lesson_release_gate.py teaching-videos/english-i-module-10-novel-study-character-theme-v2 --check
```
